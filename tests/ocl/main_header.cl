// Header code from Copernicus OpenCL node
...
// HSHADERTOY BEGIN
// The above code is generated by Houdini OpenCL node before user Kernel code. 
// Everything below is how user Kernel code is constructed in hShadertoy HDA  
